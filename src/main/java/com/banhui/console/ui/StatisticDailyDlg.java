...
public class StatisticDailyDlg
    ...
    private void search(
        ...
        allDone(new StatisticProxy().dailyStatistic1(params),
                ...
                new StatisticProxy().dailyStatistic6(params),
                new StatisticProxy().dailyStatistic7(params),
                new StatisticProxy().dailyStatistic8(params),
                new StatisticProxy().dailyStatistic9(params)
    ...
    private void searchCallback(
        ...
        if (t != null) {
            ...
            statistic5.put("totalCreditFeeAmt", to2Scale(result4, "totalCreditFeeAmt"));
