...
public class CreatePrjRepayDlg
    ...
    public void done(int result) {
        if (result == OK) {
            ...
            params.put("sub-amt", controller().getDecimal("sub-amt"));
            params.put("unpaid-amt", controller().getDecimal("unpaid-amt"));
            params.put("is-on-time-repay", controller().getBoolean("is-on-time-repay"));
            params.put("pay-time", controller().getDate("pay-time"));

            CreatePrjRepayDlg2 dlg = new CreatePrjRepayDlg2(params);
